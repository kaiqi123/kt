...
class TeacherForCifar10(object):
	...
	def build_vgg16_teacher_deleteFilters(self, images, num_classes, temp_softmax):
		print("build_vgg16_teacher_deleteFilters")
		K.set_learning_phase(True)
		...
		#width = [64-50, 64-44, 128-84, 128-106, 256-200, 256-204, 256-212, 512-372, 512-376, 512-390, 512-384, 512-398, 512-416, 4096-2540, 4096-3642] #40per,1.0
		#width = [64-58, 64-58, 128-112, 128-122, 256-238, 256-242, 256-246, 512-472, 512-476, 512-486, 512-384, 512-398, 512-416, 4096-2540, 4096-3642] #30per,1.0
		#width = [64-62, 64-62, 128-124, 128-126, 256-252, 256-254, 256-255, 512-494, 512-498, 512-502, 512-498, 512-502, 512-496, 4096-2540, 4096-3642] #20per,1.0

		#width = [64-58, 64-58, 128-112, 128-122, 256-238, 256-242, 256-246, 512-472, 512-476, 512-486, 512-384, 512-398, 512-416, 4096-3406, 4096-3908] #30per,1.3
		width = [64-62, 64-62, 128-124, 128-126, 256-252, 256-254, 256-255, 512-494, 512-498, 512-502, 512-498, 512-502, 512-496, 4096-4048, 4096-4082] #20per,2.0
		#width = [64-58, 64-58, 128-112, 128-122, 256-238, 256-242, 256-246, 512-472, 512-476, 512-486, 512-384, 512-398, 512-416, 4096-4048, 4096-4082] #30per,2.0
